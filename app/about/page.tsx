    ...
    >
      ...
      <section className="mt-20">
        ...
        {members.length > 0 ? (
          ...
          <div className="mt-10 grid gap-10 sm:grid-cols-2">
            {["President", "Vice President"].map((title) => (
              <div key={title}>
                <div className="aspect-[4/5] w-full rounded-xl bg-concrete-100 flex items-center justify-center text-concrete-300">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="h-16 w-16">
                    <circle cx="12" cy="8" r="4" /><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" />
                ...
                <h3 className="mt-4 font-display text-xl font-bold tracking-tight text-concrete-300">
                  —
                </h3>
                <p className="font-mono text-[11px] uppercase tracking-label text-concrete-300">
                  {title}
                </p>
              </div>
            ))}
