        ...
        <div className="hidden flex-col items-end gap-3.5 lg:flex">
          <div className="flex items-center gap-5">
            <a
              ...
              className="inline-flex items-center gap-2 font-display text-sm font-semibold text-ink transition-colors hover:text-brand-700"
            >
          ...
          <ul className="flex items-center gap-7">
            {nav.map((item) => {
              ...
              const linkCls = `flex items-center gap-1 font-display text-sm font-bold uppercase tracking-wide transition-colors ${
