...
const NAV: { key: NavKey; label: string; href: string }[] = [
  ...
  { key: "safety", label: "Health & Safety", href: "/admin/safety" },
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  services: <><path d="M4 7h16" /><path d="M4 12h16" /><path d="M4 17h10" /><circle cx="18.5" cy="17" r="1.5" /></>,
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      >
        ...
        <nav className="admin-scroll mt-2 min-h-0 flex-1 space-y-1 overflow-y-auto px-3">
          {items.map((n) => {
        ...
        {/* Pinned below the scrolling nav list, so it stays reachable however
            long the list gets. */}
